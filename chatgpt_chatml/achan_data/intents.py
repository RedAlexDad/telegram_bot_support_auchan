...
- Если в теме соощения пользователь запрашивает информацию об адресах магазинов, то сообщите: "адреса ашан".
- Если тема сообщения общая информаци о магазине Ашан, то сообщите: "об ашане".
