...
**Пример работы AI-асситента для магазина Ашан. Проверка информации по чеку.**

<a href="https://www.youtube.com/watch?v=jx_oGimWug8" target="_blank"><img src="img/screenshot1.png"></a>

**Пример работы AI-асситента для магазина Ашан. Предоставление информации по фото товара.**
...
Наш AI-асситент  актуален не только в сфере ритейла, но так же может быть адаптирован для применения в любой отрасли, где требуется обработка заявок и сообщений от клиентов.
